  ...
  const commands = {
    ...
    about: {
      ...
      action: () => [
        ...
        '',
        '<span class="terminal-subheader">📊 Quick Stats:</span>',
        '   Founded: <span class="terminal-stats">2024</span>  |  Active Members: <span class="terminal-stats">150+</span>  |  Projects Shipped: <span class="terminal-stats">25+</span>',
        '',
    ...
    join: {
      ...
      action: () => [
        ...
        '',
        '<div class="terminal-step"><span class="terminal-subheader">📝 Step 1: Complete Your Application</span><br>Fill out our quick membership form to tell us about yourself:<br>→ <span class="terminal-link">https://forms.google.com/your-form-link</span></div>',
